( function () {
    ...
    angular.module( 'daxude.controllers' )
        .controller( "VirtualserverAverageClientsStatisticController", VirtualserverAverageClientsStatisticController );

    function VirtualserverAverageClientsStatisticController ( API , StatUtils ) {
